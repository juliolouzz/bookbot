...
It is a simple script that takes a .txt file on the repo path `/books/file_txt` and read through the file does a report:
...
> The code is all printed on the console:
> You must have python installed and run [ python main.py ] on your terminal while inside your local repo

```
python main.py
--- Begin report of books/frankenstein.txt ---
77986 words found in the text
